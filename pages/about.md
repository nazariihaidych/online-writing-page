...
<div class="container">
  <div class="page-content">
    <h1 class="page-title">Про мене</h1>

    <div class="about-photo-block">
      <img src="{{ '/assets/images/about/photo.png' | relative_url }}" alt="Назарій Гайдич" class="about-photo">
      <div class="about-text">{% capture about_text %}{% include content/about-text.md %}{% endcapture %}{{ about_text | markdownify }}</div>
    </div>

    <div class="about-collections">
      <ul class="about-collections-grid">
        <li>
          <a href="{{ '/music' | relative_url }}">
